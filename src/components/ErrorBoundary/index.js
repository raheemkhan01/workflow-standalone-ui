                            ...
                            <div className="errorboundary-content">
                                ...
                                <div className="d-block text-right relode-btn">
                                    <button onClick={this.changeUseCase} className="btn btn-primary use-case-btn">
                                        {useCaseState==="prev" ?<i className="fa fa-angle-left arrow-left">
                                        </i>:<></>}{useCaseState==="prev"? `Previous UseCase` : `Next UseCase`}{useCaseState==="next" ? <i className="fa fa-angle-right arrow-right"></i>:<></>}</button>
                                </div>
                            </div>
                        </div>
                    </> :
