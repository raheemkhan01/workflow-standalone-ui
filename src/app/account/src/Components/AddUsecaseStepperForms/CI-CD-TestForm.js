      ...
      <div>
        ...
        <div className="font-semibold">
          ...
          <div className="mt-7 font-semibold ">
            <h2 className="font-bold text-[#262626]">CI/CD Test Sub Stages</h2>
            <h4 className="mt-3 text-[#262626]">Create CI/CD Pipeline</h4>
            <div className="flex mt-4">
            <div className="flex flex-col text-[#A8A8A8]  ">
              <p >Assign To:</p>
              <Select className="w-40 h-6 mt-2  " placeholder="Action">
          ...
          <div className="mt-7 font-semibold ">
            <h2 className="mt-3 text-[#262626]">Create Kubernetes Operator</h2>
            <div className="flex mt-4">
            <div className="flex flex-col text-[#A8A8A8]  ">
              <p >Assign To:</p>
              <Select className="w-40 h-6 mt-2  " placeholder="Action">
          ...
          <div className="mt-7 font-semibold ">
            <h2 className="text-[#262626]">Link API with Github and Netlifi</h2>
            <div className="flex mt-4">
            <div className="flex flex-col text-[#A8A8A8]  ">
              <p >Assign To:</p>
              <Select className="w-40 h-6 mt-2  " placeholder="Action">
          ...
          <div className="mt-7 font-semibold ">
            <h2 className="text-[#262626]">Upload Test env URL in Netlifi site</h2>
            <div className="flex mt-4">
            <div className="flex flex-col text-[#A8A8A8]  ">
              <p >Assign To:</p>
              <Select className="w-40 h-6 mt-2  " placeholder="Action">
          ...
          <div className="mt-7 font-semibold ">
            <h2 className="text-[#262626]">Upload Test Result in S3 Website</h2>
            <div className="flex mt-4">
            <div className="flex flex-col text-[#A8A8A8]  ">
              <p >Assign To:</p>
              <Select className="w-40 h-6 mt-2  " placeholder="Action">
          ...
          <div className="mt-7 font-semibold ">
            <h2 className="text-[#262626]">Stage After Review</h2>
            <div className="flex mt-4">
            <div className="flex flex-col text-[#A8A8A8]  ">
              <p >Assign To:</p>
              <Select className="w-40 h-6 mt-2  " placeholder="Action">
