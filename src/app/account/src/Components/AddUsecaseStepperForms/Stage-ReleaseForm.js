      ...
      <div>
        ...
        <div className="font-semibold">
          ...
          <div className="mt-7 font-semibold ">
            <h2 className="font-bold text-[#262626] ">Stage/Release Sub-Stages</h2>
            <h4 className="mt-3 text-[#262626] ">Stage test And Review</h4>
            <div className="flex mt-4">
            <div className="flex flex-col text-[#A8A8A8]  ">
              <p >Assign To:</p>
              <Select className="w-40 h-6 mt-2  " placeholder="Action">
          ...
          <div className="mt-7 font-semibold ">
            <h2 className="mt-3 text-[#262626] ">Promote to Prod</h2>
            <div className="flex mt-4">
            <div className="flex flex-col text-[#A8A8A8]  ">
              <p >Assign To:</p>
              <Select className="w-40 h-6 mt-2  " placeholder="Action">
          ...
          <div className="mt-7 font-semibold ">
            <h2 className="text-[#262626] ">API Security Test in Prod</h2>
            <div className="flex mt-4">
            <div className="flex flex-col text-[#A8A8A8]  ">
              <p >Assign To:</p>
              <Select className="w-40 h-6 mt-2  " placeholder="Action">
          ...
          <div className="mt-7 font-semibold ">
            <h2 className="text-[#262626] ">Create/Update Release Note</h2>
            <div className="flex mt-4">
            <div className="flex flex-col text-[#A8A8A8]  ">
              <p >Assign To:</p>
              <Select className="w-40 h-6 mt-2  " placeholder="Action">
...
export default StageReleaseForm;
